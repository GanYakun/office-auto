...
//                "partyId", partyId, "partyGeoTypeId", "REGISTERED_COUNTRY"));
        ...
        serviceParam.put("partyContentTypeId", "FINANCE_REPORT");
        ...
        serviceParam.put("partyContentTypeId", "NDA");
        dispatcher.runSync("banfftech.createPartyMediaResource", serviceParam);
        ...
        serviceParam.put("partyContentTypeId", "SOQ");
        dispatcher.runSync("banfftech.createPartyMediaResource", serviceParam);
        ...
        serviceParam.put("partyContentTypeId", "BUSINESS_CODE_CONDUCT");
        dispatcher.runSync("banfftech.createPartyMediaResource", serviceParam);
